...
export default function SellerPanel() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingId) {
        ...
        setMsg({ text: 'Cliente actualizado con éxito', type: 'success' });
      } else {
        await axios.post(
        ...
        setMsg({ text: 'Cliente agregado con éxito', type: 'success' });
      }
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      setMsg({ text: 'Cliente eliminado con éxito', type: 'success' });
      await loadData();
    } catch (err) {
      setMsg({
      ...
      <main className="panel-content">
        ...
        <section className="dashboard-section">
          <div className="welcome-card">
            ...
            <div className="stats-grid">
              ...
              <div className="stat-card">
                <span className="stat-value">{summary?.totalSales ?? 0}</span>
        ...
        <form onSubmit={handleSubmit} className="client-form">
          <h2 className="form-title">
            {editingId ? (
              <><i className="fas fa-edit"></i> Editar Persona</>
            ) : (
        ...
        <section className="clients-section">
          <div className="section-header">
            <h2 className="section-title">
              <i className="fas fa-users"></i> Personas a Cargo
            </h2>
            <div className="total-count">
              Total: {filteredClients.length} {filteredClients.length === 1 ? 'persona' : 'personas'}
            </div>
          </div>
